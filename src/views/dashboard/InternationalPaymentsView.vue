<script setup>
    ...
    const fetchPaymentTypes = async () => {
        try {
            ...
            const first = arr[0];
            selectedPaymentTypeId.value = first ? first.id : null;
        } catch {
    ...
    const paymentTypeDefaultOption = computed(() => {
        const first = Array.isArray(paymentTypeOptions.value) && paymentTypeOptions.value.length
            ? paymentTypeOptions.value[0]
            : null;
    ...
    const paymentTypeTitleClass = computed(() => (errors.value.paymentType ? 'border border-[#EF4444]' : ''));
                        ...
                        <div class="flex flex-col gap-4 h-fit p-[22px] rounded-[20px] mb-4 bg-mainWhite">
                            <div class="block">
                                ...
                                <input
                                    ...
                                    :class="{ 'border border-[#EF4444]': errors.firstName }" type="text" id="name"
                            ...
                            <div class="block">
                                ...
                                <input
                                    class="block w-full text-[15px] font-Gilroy bg-[#EEF2ED] rounded-[10px] py-3 px-5 placeholder:text-[#6F736D] text-[#191B19]"
                                    :class="{ 'border border-[#EF4444]': errors.lastName }" type="text" id="fullName"
                                    placeholder="Фамилия" v-model="lastName">
                            </div>
                            <div class="block">
                                ...
                                <input
                                    class="block w-full text-[15px] font-Gilroy bg-[#EEF2ED] rounded-[10px] py-3 px-5 placeholder:text-[#6F736D] text-[#191B19]"
                                    :class="{ 'border border-[#EF4444]': errors.patronymic }" type="text"
                                    id="patronymic" placeholder="Отчество" v-model="patronymic">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-4">
                        <div class="flex flex-col gap-4 h-fit p-[22px] rounded-[20px] mb-4 bg-mainWhite">
                            <div class="block">
                                ...
                                <input
                                    class="block w-full text-[15px] font-Gilroy bg-[#EEF2ED] rounded-[10px] py-3 px-5 placeholder:text-[#6F736D] text-[#191B19]"
                                    :class="{ 'border border-[#EF4444]': errors.homeAddress }" type="text" id="address"
                                    placeholder="Домашний адрес" v-model="homeAddress">
                            </div>
                            ...
                            <div class="block">
                                ...
                                <div class="flex">
                                    <input
                                        ...
                                        :class="{ 'border border-[#EF4444]': errors.passportSeries }" type="text"
                                        id="passportId" placeholder="AS" maxlength="2" v-model="passportSeries">
                                    <input
                                        class="block w-full text-[15px] font-Gilroy bg-[#EEF2ED] rounded-[10px] py-3 px-5 placeholder:text-[#6F736D] text-[#191B19]"
                                        :class="{ 'border border-[#EF4444]': errors.passportNumber }" type="text"
                                        id="passport_number" placeholder="Номер паспорта" maxlength="6"
                        ...
                        <div class="flex flex-col gap-4 h-fit p-[22px] rounded-[20px] bg-mainWhite">
                            ...
                            <div v-for="(title, idx) in requiredFiles" :key="'upload-' + idx" class="block relative">
                                ...
                                <label :for="'scan-' + idx"
                                    ...
                                    :class="{ 'border border-[#EF4444]': errors.files && !fileUploads[idx] }">
