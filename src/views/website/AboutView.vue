    ...
    <div class="auto_container">
      <div class="wrap">
        <div class="flex gap-x-4">
          ...
          <div
            class="w-[290px] rounded-[20px] flex items-center justify-center glow relative overflow-hidden bg-[#1D2417]">
            <img src="../../assets/images/senagat-big.png" class="w-[200px] block object-contain z-[1]" alt="emblem">
          </div>
        </div>
      </div>
    </div>
