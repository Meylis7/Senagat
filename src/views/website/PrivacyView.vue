    ...
    <section class="py-[50px] pb-[120px]">
        <div class="auto_container">
            <div class="wrap">
                ...
                <div v-for="(section, idx) in privacySections" :key="idx" class="block mb-10">
                    <h4 class="text-[#191B19] text-[28px] font-bold mb-5">
                        {{ section.title }}
                    </h4>
                    <p v-if="section.text" class="text-[#6F736D] text-[17px] font-Gilroy mb-5" v-html="section.text">
                    </p>
                    <ul v-if="Array.isArray(section.list)" class="list-outside">
                        <li v-for="(li, i) in section.list" :key="i" class="mb-5">
                            <p class="text-[#6F736D] text-[17px] font-Gilroy" v-html="li"></p>
                        </li>
                    </ul>
                    <p v-if="section.subText" class="text-[#6F736D] text-[17px] font-Gilroy mb-5"
