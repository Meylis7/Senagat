<script setup>
    ...
    const fetchOtherCards = async () => {
        ...
        try {
            ...
            otherCards.value = arr.filter((it) => String(it.id) !== String(cardId.value))
        } catch (e) {
    ...
    <section class="hero pt-[145px] pb-[60px] bg-mainBlack relative overflow-hidden">
        <div class="auto_container">
            <div class="hero_wrap">
                ...
                <!-- <p class="text-[17px] font-Gilroy text-mainWhite/60 text-center" v-html="card.description || ''">
                </p> -->
        ...
        <div class="auto_container">
            <div class="wrap">
                ...
                <div class="block p-8 rounded-[20px] mb-4 bg-mainWhite">
                    <div v-for="(adv, i) in (card?.details || [])" :key="i">
