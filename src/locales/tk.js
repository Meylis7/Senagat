export default {
  ...
  dashboard: {
    ...
    noPaymentsYet: 'Heniz hiç hili töleg geçirilmedi',
  },
  ...
  form: {
    ...
    input: {
      ...
      workAddress: 'Iş ýeriniň salgysy',
      salary: 'Zähmet haky',
      workplace: 'Iş ýeri',
      position: 'Wezipesi',
    ...
    select: {
      ...
      selectBankBranch: 'Bank şahamçasyny saýlaň',
      bankBranch: 'Bank şahamçasy',
      isEntrepreneur: 'Siz telekeçimi?',
      yes: 'Hawa',
      no: 'Ýok',
      selectCertificateType: 'Guwanamanyň görnüşini saýlaň',
      certificateType: 'Guwanamanyň görnüşi',
      internetService: 'Internet hyzmaty',
      delivery: 'Eltip bermek',
      selectApplicationType: 'Arzanyň görnüşini saýlaň',
      applicationType: 'Arzanyň görnüşi',
    },
  },
